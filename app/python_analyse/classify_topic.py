...
finish = ['毕业生',  '毕业', '毕业照', '实习', '论文', '答辩', '工作', '招聘会', '简历', '薪水', '面试']

all_tag = [market_tag, help_tag, campus_tag, college_tag, network_tag, emotion_list, finish]
